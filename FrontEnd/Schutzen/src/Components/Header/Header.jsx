...
function Header() {
  return (
    <>
      <header className='h-[10vh] font-[Google_Sans] w-full bg-linear-to-br from-[#0047ab] to-[#002147] stiky top-0'>
        <nav className='h-full w-full flex'>
          <h1 className='h-10em w-full font-[IBM_Plex_Serif] font-bold text-[30px] flex flex-row gap-3 items-center justify-start p-2 uppercase'>
